...
export default function Cascade() {
  ...
  return (
    <div style={S.root}>
      ...
      {showAchievements && (
        <div style={S.ovTop} onClick={() => setShowAchievements(false)}>
          <div style={{ ...S.ovCard, maxWidth: 400 }} onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{ height: 6, background: T.line, borderRadius: 999, overflow: "hidden", marginBottom: 20 }}>
              <div style={{ height: "100%", width: `${(achievements.length / ACHIEVEMENTS.length) * 100}%`, background: T.gold, borderRadius: 999, transition: "width 400ms ease" }} />
            </div>
            ...
            <button style={{ ...S.primary, marginTop: 20 }} onClick={() => setShowAchievements(false)}>Close</button>
          </div>
        </div>
      )}
